...
#        self.graph.fitwin.params_ui_to_func()
#        params = self.graph.fitwin.params_func_to_flat()
        self.graph.fitwin.destroy_ui()

        old = self.graph.fitdatasets[:]

        if not self.shifted and len(self.graph.datasets) > 1 and self.graph.datasets[id] not in self.graph.fitdatasets:
...
#        self.graph.fitwin.params_flat_to_func(params)
#        self.graph.fitwin.params_func_to_ui()
#        self.graph.update_function_curves()
