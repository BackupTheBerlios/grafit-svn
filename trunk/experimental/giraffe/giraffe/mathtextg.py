...
def math_parse_s_ft2font(s, dpi, fontsize, angle=0):
    ...
    if math_parse_s_ft2font.cache.has_key(cacheKey):
        w, h, origin, bfonts = math_parse_s_ft2font.cache[cacheKey]
        return w, h, origin, bfonts.fonts.values()
    ...
    math_parse_s_ft2font.cache[cacheKey] = w, h, origin, bakomaFonts
    return w, h, origin, bakomaFonts.fonts.values()
